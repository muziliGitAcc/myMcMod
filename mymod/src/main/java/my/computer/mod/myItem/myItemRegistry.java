...
public class myItemRegistry {
    ...
    public static RegistryObject<Item> myComputerBlock = ITEMS.register("my_computer_block", () -> new BlockItem(myBlockRegistry.myComputerBlock.get(), new Item.Properties().group(itemGroup)));
